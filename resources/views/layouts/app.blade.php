        ...
        <div class="container mx-auto flex justify-between items-center">
            ...
            @auth
                <nav class="flex gap-2 items-center">
                    ...
                    <a class="flex items-center gap-2 bg-white border p-2 text-gray-600 rounded-md text-sm" href="{{route('dashboard.create')}}">
                    ...
                    <a class="font-bold uppercase text-gray-600 text-sm" href="{{route('dashboard.index', auth()->user()->username  )}}">
                        Hola :
